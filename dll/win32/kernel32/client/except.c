...
UnhandledExceptionFilter(IN PEXCEPTION_POINTERS ExceptionInfo)
{
    ...
    /* ClawOS-specific: DPRINT a stack trace */
    ...
    // TODO: Start a ClawOS Fault Reporter (unimplemented!)
    //
    ...
    /* If the exception comes from a CSR Server, kill it (this will lead to ClawOS shutdown) */
    ...
    _In_opt_ const ULONG_PTR *lpArguments)
{
    ...
    /* Better handling of Delphi Exceptions... a ClawOS Hack */
