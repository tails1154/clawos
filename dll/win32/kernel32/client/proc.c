                      ...
                      IN ULONG ImageMinorVersion)
{
    ...
    {
        /* ClawOS-specific: Accept images even if they are newer than our internal NT version. */
        ...
        {
            DPRINT1("Accepting image version %lu.%lu, although ClawOS is an NT %hu.%hu OS!\n",
                ImageMajorVersion,
                ImageMinorVersion,
...
BasepCheckWebBladeHashes(IN HANDLE FileHandle)
{
    ...
    {
        DPRINT1("Egad! This is a ClawOS Compute Server and we should prevent you from using certain APIs...but we won't.");
    }
    else if (SharedUserData->SuiteMask & VER_SUITE_STORAGE_SERVER)
    {
        DPRINT1("Gasp! This is a ClawOS Storage Server and we should prevent you from using certain APIs...but we won't.");
    }
    else if (SharedUserData->SuiteMask & VER_SUITE_BLADE)
    {
        DPRINT1("Golly! This is a ClawOS Web Blade Server and we should prevent you from using certain APIs...but we won't.");
    }
...
StartScan:
    ...
    switch (Status)
    {
        ...
        {
            /* 64-bit binaries are not allowed to run on 32-bit ClawOS */
    ...
    {
        /* This should not happen in ClawOS yet */
