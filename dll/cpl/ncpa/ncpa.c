/*
 * PROJECT:         ClawOS Network Control Panel
 * FILE:            dll/cpl/ncpa/ncpa.c
 * PURPOSE:         ClawOS Network Control Panel
...
DisplayApplet(VOID)
{
	...
	/* NOTE: If Explorer shell is not available, use ClawOS's alternative file browser instead */
