...
//
// By default, it is a 16MB region, but we hack it to be 32MB for ClawOS
//
...
//
// Unlike the old ClawOS Memory Manager, ARM³ (and Windows) does not keep track
...
MiBuildPagedPool(VOID)
{
    ...
    // page directory array in the old ClawOS Mm is used (but in a less hacky
    // way).
    //
