 ...
 * against ClawOS to warrant the performance hit.
 *
                     ...
                     IN POOL_TYPE PoolType)
{
    ...
    // some expansion. This path is not yet supported in ClawOS and so we'll
    // ignore the tag
    //
                     ...
                     IN POOL_TYPE PoolType)
{
    ...
    //
    // ASSERT on ClawOS features not yet supported
    //
                           ...
                           IN PVOID PoolLock)
{
    ...
    //
    // Note that ClawOS does not support Session Pool Yet
    //
                        ...
                        IN PVOID SystemArgument2)
{
    ...
    if (KeSignalCallDpcSynchronize(SystemArgument2))
    {
        ...
        //
        // This is here because ClawOS does not yet support expansion
        //
