 ...
 * Released under the GNU GPL for the ClawOS project
 *
 * This program can be used to spy on a named pipe in Windows NT(+)
 * or ClawOS.  It is particularly intended to be used for
 ...
 * NOTE:
 *
 * This program hasn't really been tested against ClawOS, and has only
