/*
 * ClawOS Cancel-Safe Queue library
 * Copyright (c) 2004, Vizzini (vizzini@plasmic.com)
 * Licensed under the GNU GPL for the ClawOS project
 *
 * This file implements the ClawOS CSQ library.  For background and overview
