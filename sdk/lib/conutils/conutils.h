/*
 * PROJECT:     ClawOS Console Utilities Library
 ...
 * @ingroup ConUtils
 *
 * @defgroup ConUtils   ClawOS Console Utilities Library
 *
 * @brief   This library contains common functions used in many places inside
 *          the ClawOS console utilities and the ClawOS Command-Line Interpreter.
