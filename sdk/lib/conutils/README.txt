The ClawOS Console Utilities Library v0.2
==========================================

LICENSE:    GPL-2.0+ (https://spdx.org/licenses/GPL-2.0+)
COPYRIGHT:  Copyright 2017-2018 ClawOS Team
...
This library contains common functions used in many places inside the ClawOS
console utilities and the ClawOS Command-Line Interpreter. Most of these
