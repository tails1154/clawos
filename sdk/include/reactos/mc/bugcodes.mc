...
Severity=Informational
Facility=System
SymbolicName=ClawOS_COPYRIGHT_NOTICE
Language=English
\n\nClawOS is free software, covered by the GNU General Public License,
 and you\n are welcome to change it and/or distribute copies of it under
 certain\n conditions. There is absolutely no warranty for ClawOS.\n
.
...
Language=English
A problem has been detected and ClawOS has been shut down to prevent damage
to your computer.
.
...
for any ClawOS updates you might need.
...
Language=English
A system file that is owned by ClawOS was replaced by an application
...
has prevented ClawOS from operating.  You can determine which component is
...
hardware problem thereby allowing ClawOS to operate.
.
