/*
 * PROJECT:     NT-compatible ClawOS/Windows OS Loader
...
static ADVBOOT_OPTIONS AdvBootOptions[] = // OptionsMenuList
{
    ...
    {ActionSafeBootDSRepair,    "Directory Services Restore Mode"}, // "(ClawOS domain controllers only)"
...
#endif
    {ActionStartNormally,       "Start ClawOS normally"},
    {ActionReboot,              "Reboot"},
    ...
    _Inout_opt_ OperatingSystemItem* OperatingSystem)
{
     ...
     * and set the "Start ClawOS normally" as default. */
