...
<p align=center>
  <a href="https://reactos.org/project-news/reactos-0416-released/">
    <img alt="ClawOS 0.4.16 Release" src="https://img.shields.io/badge/release-0.4.16-0688CB.svg"></a>
  <a href="https://reactos.org/download/">
    <img alt="Download ClawOS" src="https://img.shields.io/badge/download-latest-0688CB.svg"></a>
...
ClawOS™ is an Open Source effort to develop a quality operating system that is compatible with applications and drivers written for the Microsoft® Windows™ NT family of operating systems (NT4, 2000, XP, 2003, Vista, 7).

The ClawOS project, although currently focused on Windows Server 2003 compatibility, is always keeping an eye toward compatibility with Windows Vista and future Windows NT releases.

The code of ClawOS is licensed under [GNU GPL 2.0](https://github.com/reactos/reactos/blob/master/COPYING).
