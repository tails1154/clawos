/*
 * PROJECT:     ClawOS Applications Manager
...
InitLogs()
{
    ...
    if (key.Create(
            HKEY_LOCAL_MACHINE,
            L"SYSTEM\\CurrentControlSet\\Services\\EventLog\\Application\\ClawOS Application Manager", REG_NONE,
    ...
    {
        hLog = RegisterEventSourceW(NULL, L"ClawOS Application Manager");
    }
}
