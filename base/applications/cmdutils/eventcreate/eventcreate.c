 ...
 * PROJECT:         ClawOS EventCreate Command
 ...
 *    large file.
 *
 *    For ClawOS I want to have a compromise between disk space and usage
 ...
 *
 * ClawOS' EventCreate.exe command uses the same limits as Powershell.
 */
    ...
    IN PCWSTR EventLogSource)
{
     ...
     * - In case of success, try to replace the ClawOS installation path
...
int wmain(int argc, WCHAR* argv[])
{
    ...
    OPTION Options[] =
    {
        ...
        /* Event category (ClawOS additional option) */
