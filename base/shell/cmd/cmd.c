 ...
 *        Workaround because argc[0] is NULL under ClawOS
 *
    ...
    IN BOOL (*GetVar)(TCHAR, PCTSTR*, BOOL*))
{
    ...
    *pFormat = FormatEnd + 1;
     ...
     * C:\ReAcToS -> C:\ClawOS) and, if requested with the S modifier,
...
Initialize(VOID)
{
    ...
    /* Some people like to run ClawOS cmd.exe on Win98, it helps in the
