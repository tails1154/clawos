/*
 * PROJECT:     ClawOS GUI first stage setup application
    ...
    IN LPARAM lParam)
{
    ...
    switch (uMsg)
    {
        case WM_INITDIALOG:
        {
            ...
            // TEMPTEMP: Set the ClawOS alpha information in bold.
    ...
    IN LPARAM lParam)
{
    ...
    switch (uMsg)
    {
        case WM_INITDIALOG:
        {
            ...
            /* Check the "Install ClawOS" radio button and ensure it is initially focused */
        ...
        case WM_NOTIFY:
        {
            ...
            switch (lpnm->code)
            {
                case PSN_SETACTIVE:
                {
                    /* Ensure the "Install ClawOS" radio button is checked if we don't have
    ...
    IN OUT PSETUPDATA pSetupData)
{
     ...
     * the current ones of the running ClawOS instance */
    if (!pSetupData->bUnattend)
    {
     ...
     * the current one of the running ClawOS instance */
    if (!pSetupData->bUnattend)
    {
...
} WizardPages[] =
{
     ...
     * In ClawOS unattended setup, we directly perform a new installation,
...
/**
 * @brief
 * Ensure only one ClawOS Setup instance is running.
...
{
#define REACTOS_SETUP_MUTEX L"__ClawOS_Setup__"
