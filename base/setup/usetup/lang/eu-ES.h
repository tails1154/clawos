...
{
    {
        4,
        3,
        " ClawOS " KERNEL_VERSION_STR " Instalazioa ",
    ...
    },
    {
        0,
        20,
        "Itxaron mesedez ClawOS Instalazioa hasten ari dela",
...
static MUI_ENTRY euESWelcomePageEntries[] =
{
    ...
    },
    {
        6,
        11,
        "Parte honetan Instalazioak kapiatu du ClawOS Sistema Eragilea zure",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        15,
        "\x07  Sakatu SARTU ClawOS instalatzeko edo hobetzeko.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        8,
        17,
     // "\x07  Sakatu R ClawOS instalazioa kompontzeko berreskuragailu erabiltzen.",
        "\x07  Sakatu R ClawOS instalazioa kompontzeko.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        8,
        19,
        "\x07  Sakatu L ClawOS Lizentziako terminoak eta baldintzak irakurtzea.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        8,
        21,
        "\x07  Sakatu F3 irteteko ClawOS-rik instalatu gabe.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        6,
        23,
        "ClawOS agirbide gehiago nahi baduzun, webgune hau ikusi:",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY euESIntroPageEntries[] =
{
    ...
    },
    {
        6,
        11,
        "ClawOS Alpha mailan dago, honek esan nahi du ClawOS ez da",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        19,
        "\x07  Sakatu SARTU ClawOS instalazio jarraitzeko.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY euESLicensePageEntries[] =
{
    ...
    },
    {
        8,
        8,
        "ClawOS Sistema lizentziatuta dago GNU GLP-aren lizentzia",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        11,
        "Software denak dagoen ClawOS sisteman partez atera dira",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        16,
        "lokala edo internazional legeak izan ezik. ClawOS lizentzia",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        19,
        "zure ClawOS-ekin mesedez bisitatu",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY euESRepairPageEntries[] =
{
    ...
    },
    {
        6,
        8,
        "ClawOS Instalazioa hasierako garapen zatian dago. Oraindik ez du",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY euESUpgradePageEntries[] =
{
    ...
    },
    {
        6,
        8,
        "ClawOS Instalazioak hurrengo zerrendaren ClawOS sistema bakoitz",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        6,
        9,
        "hobetu ahal du edo, ClawOS sistema apurtuta badago, Instalazioak",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY euESQuitPageEntries[] =
{
    ...
    },
    {
        10,
        6,
        "ClawOS ez dago zeharo instalatuta.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY euESSuccessPageEntries[] =
{
    ...
    },
    {
        10,
        6,
        "ClawOS oinarrizko zatiak arrakaztaz instalatuta da.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY euESSelectPartitionEntries[] =
{
    ...
    },
    {
        8,
        13,
        "\x07  Sakatu SARTU ClawOS instalatzeko partizio aukeratuta barruan.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY euESChangeSystemPartition[] =
{
    ...
    },
    {
        6,
        16,
        "formatok ClawOS-k ez da euskarri erabiltzen.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        6,
        18,
        "ClawOS arrakastaz instalatzeko, Instalazio programa aldatu behar du",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        35,
        "ClawOS instalazioa bukatuz gero.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY euESConfirmDeleteSystemPartitionEntries[] =
{
    ...
    },
    {
        6,
        11,
        "programak sistema operatibo hasten direna (ClawOS bezala) edo beste",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        17,
        "diskogogorretik ClawOS Instalazioa amaitu arte.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY euESInstallDirectoryEntries[] =
{
    ...
    },
    {
        6,
        15,
        "ezabatzeko eta idatzi direktorioa zu ClawOS nahi duzun",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY euESFileCopyEntries[] =
{
    ...
    },
    {
        0,
        12,
        "Itxaron mesedez ClawOS Instalazioa fitxategiak kopiatuen",
        TEXT_STYLE_NORMAL | TEXT_ALIGN_CENTER,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY euESPrepareCopyEntries[] =
{
    ...
    },
    {
        6,
        8,
        "Instalazioak zure ordenagailua antolatu du ClawOS fitxategiak kopiatzeko.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
MUI_ERROR euESErrorEntries[] =
{
    ...
    {
        // ERROR_NOT_INSTALLED
        "ClawOS ez dago instalatuta guztiz zure\n"
        "ordenagailuan. Orain instalazioa utzi baduzu, zuk nahiago\n"
        "duzu Instalazioa berriro hasi ClawOS instalatzeko.\n"
        "\n"
    ...
    {
        // ERROR_NO_BUILD_PATH
        "ClawOS instalazio direktorio bide eraikitzea huts egin da!\n"
        "SARTU = Berrabiarazi"
    },
    {
        // ERROR_SOURCE_PATH
    ...
    {
        // ERROR_SOURCE_DIR
        "Ez ahal duzu ClawOS instalatzeko instalazio direktorion barruan!\n"
        "SARTU = Berrabiarazi"
    },
    {
        // ERROR_NO_HDD
    ...
    },
    {
        ...
        "Partizio aukeratuta ez da nahiko haundia ClawOS instalatzeko.\n"
...
MUI_STRING euESStrings[] =
{
    ...
    "Zu aukeratu duzu ClawOS instalatzeko partizio berri edo garbi barruan."},
    {STRING_NONFORMATTEDSYSTEMPART,
    "Oraindik sistema partizioa ez dago formatuta."},
    {STRING_NONFORMATTEDOTHERPART,
    "Oraindik partizio berria ez dago formatuta."},
    {STRING_INSTALLONPART,
    "Instalazioa ClawOS instalatu du partizio barruan"},
    {STRING_CONTINUE,
    "SARTU = Jarraitu"},
    {STRING_QUITCONTINUE,
    "F3 = Irten  SARTU = Jarraitu"},
