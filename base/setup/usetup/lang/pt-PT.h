...
{
    {
        4,
        3,
        " Instala\207\306o do ClawOS " KERNEL_VERSION_STR " ",
    ...
    },
    {
        0,
        20,
        "Por favor aguarde enquanto o Instalador do ClawOS inicializa",
...
static MUI_ENTRY ptPTWelcomePageEntries[] =
{
    ...
    },
    {
        6,
        8,
        "Bem-vindo ao assist\210nte de instala\207\306o do ClawOS.",
    ...
    },
    {
        6,
        11,
        "Esta fase da instala\207\306o prepara o ClawOS para ser",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        15,
        "\x07  Pressione ENTER para instalar ou actualizar o ClawOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        8,
        17,
        "\x07  Para reparar uma instala\207\306o do ClawOS, pressione R.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        21,
        "\x07  Para sair sem instalar o ClawOS, pressione F3.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        6,
        23,
        "Para mais informa\207\344es sobre o ClawOS, visite o s\241tio:",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY ptPTIntroPageEntries[] =
{
    ...
    },
    {
        6,
        11,
        "O ClawOS est\240 em est\240gio Alpha, o que significa que n\306o est\240 completo",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        16,
        "secund\240rio se pretende executar o ClawOS em hardware real.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        8,
        19,
        "\x07  Pressione ENTER para continuar a instala\207\306o do ClawOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        8,
        21,
        "\x07  Pressione F3 para terminar sem instalar o ClawOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY ptPTLicensePageEntries[] =
{
    ...
    },
    {
        8,
        8,
        "O ClawOS est\240 licenciado sob os termos da licen\207a",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        11,
        "Todo o software que faz parte do sistema ClawOS \202 portanto,",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        17,
        "A licen\207a do ClawOS abrange apenas a distribui\207\306o a terceiros.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        19,
        "GNU General Public License com o ClawOS por favor visite",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY ptPTRepairPageEntries[] =
{
    ...
    },
    {
        6,
        8,
        "O instalador do ClawOS est\240 em fase inicial de desenvolvimento e",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY ptPTUpgradePageEntries[] =
{
    ...
    },
    {
        6,
        8,
        "Com o Instalador do ClawOS pode actualizar uma das instala\207\344es",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        6,
        9,
        "dispon\241veis listadas abaixo, ou, se tem uma instala\207\306o do ClawOS",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY ptPTQuitPageEntries[] =
{
    ...
    },
    {
        10,
        6,
        "O ClawOS n\306o foi totalmente instalado neste computador.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY ptPTSuccessPageEntries[] =
{
    ...
    },
    {
        10,
        6,
        "Os componentes b\240sicos do ClawOS foram instalados com sucesso.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY ptPTSelectPartitionEntries[] =
{
    ...
    },
    {
        8,
        13,
        "\x07  Para configurar o ClawOS no item seleccionado, pressione ENTER.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY ptPTChangeSystemPartition[] =
{
    ...
    },
    {
        6,
        16,
        "formato n\306o suportado pelo ClawOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        6,
        18,
        "Para instalar o ClawOS com sucesso, o instalador deve alterar",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        35,
        "ap\242s a instala\207\306o do ClawOS ser concluida.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY ptPTConfirmDeleteSystemPartitionEntries[] =
{
    ...
    },
    {
        6,
        12,
        "(ClawOS) ou outro e programas fornecidos pelo fabricante do hardware.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        17,
        "computador pelo disco r\241gido at\202 concluir a instala\207\306o do ClawOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY ptPTInstallDirectoryEntries[] =
{
    ...
    },
    {
        6,
        9,
        "Seleccione o direct\242rio onde deseja que o ClawOS seja instalado:",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        15,
        "o texto e escreva o nome do direct\242rio onde deseja que o ClawOS",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY ptPTFileCopyEntries[] =
{
    ...
    },
    {
        0,
        13,
        "ficheiros do ClawOS para a pasta de instala\207\306o.",
        TEXT_STYLE_NORMAL | TEXT_ALIGN_CENTER,
        TEXT_ID_STATIC
    },
    {
...
MUI_ERROR ptPTErrorEntries[] =
{
    ...
    {
        // ERROR_NOT_INSTALLED
        "O ClawOS n\306o est\240 completamente instalado no computador.\n"
        "Se sair da instala\207\306o agora, precisar\240 executa-la\n"
        "novamente para instalar o ClawOS.\n"
        "\n"
    ...
    {
        // ERROR_NO_BUILD_PATH
        "Falha ao criar os caminhos para o direct\242rio de instala\207\306o do ClawOS!\n"
    ...
    {
        // ERROR_SOURCE_DIR
        "N\306o pode instalar o ClawOS dentro do direct\242rio de origem da instala\207\306o!\n"
        "ENTER = Reiniciar o computador"
    },
    {
        // ERROR_NO_HDD
    ...
    },
    {
        ...
        "A parti\207\306o selecionada n\306o \202 grande o suficiente para instalar o ClawOS.\n"
...
//    "Voc\210 solicitou a cria\207\306o de uma nova parti\207\306o em"},
    ...
    "Solicitou instalar o ClawOS numa parti\207\306o nova ou sem formato."},
    {STRING_NONFORMATTEDSYSTEMPART,
    "A parti\207\306o ainda n\306o est\240 formatada."},
    {STRING_NONFORMATTEDOTHERPART,
    "A nova parti\207\306o ainda n\306o est\240 formatada."},
    {STRING_INSTALLONPART,
    "O instalador instala o ClawOS na parti\207\306o"},
    {STRING_CONTINUE,
    "ENTER=Continuar"},
    {STRING_QUITCONTINUE,
    "F3=Sair  ENTER=Continuar"},
