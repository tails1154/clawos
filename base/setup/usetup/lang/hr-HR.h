...
{
    {
        4,
        3,
        " ClawOS " KERNEL_VERSION_STR " instalacija ",
...
static MUI_ENTRY hrHRWelcomePageEntries[] =
{
    ...
    },
    {
        6,
        8,
        "Dobrodo\347li u ClawOS instalaciju",
    ...
    },
    {
        6,
        11,
        "Ovaj dio instalacije kopira ClawOS na va\347e",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        15,
        "\x07  Pritisnite ENTER za instalaciju ili nadogradnju ClawOS-a.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        8,
        17,
     // "\x07  Pritisnite R za popravak ClawOS instalacije koriste†i Recovery Console.",
        "\x07  Pritisnite R za popravak ClawOS instalacije.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        8,
        19,
        "\x07  Pritisnite L da vidite ClawOS licencni ugovor.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        8,
        21,
        "\x07  Pritisnite F3 da biste iza\347li bez instalacije ClawOS-a.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        6,
        23,
        "Za vi\347e informacija o ClawOS-a, posjetite:",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY hrHRIntroPageEntries[] =
{
    ...
    },
    {
        6,
        11,
        "ClawOS je u Alphi, \347to zna\237i da nije potpun svih funkcija",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        17,
        "ra\237unalu da biste pokrenuli ClawOS na fizi\237kom ra\237unalu.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        8,
        20,
        "\x07  Pritisnite ENTER da biste nastavili ClawOS instalaciju.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY hrHRLicensePageEntries[] =
{
    ...
    },
    {
        8,
        11,
        "Sav software je dio ClawOS sustava",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        17,
        "ClawOS-a pokriva distribuciju samo tre\206im stranama.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        19,
        "GNU General Public licence s ClawOS molimo posjetite",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY hrHRRepairPageEntries[] =
{
    ...
    },
    {
        6,
        8,
        "ClawOS instalacija je u ranoj fazi razvijanja. Jo\347 nema",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY hrHRUpgradePageEntries[] =
{
    ...
    },
    {
        6,
        8,
        "ClawOS instalacija mo\247e a\247urirati jednu postoje\206u ClawOS instalaciju",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        6,
        9,
        "napisanu ispod, ili, ako je ClawOS instalacija je o\347te\206ena,",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY hrHRQuitPageEntries[] =
{
    ...
    },
    {
        10,
        6,
        "ClawOS nije potpuno instaliran.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY hrHRSuccessPageEntries[] =
{
    ...
    },
    {
        10,
        6,
        "Osnovni dijelovi ClawOS-a su se uspje\347no instalirali.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY hrHRSelectPartitionEntries[] =
{
    ...
    },
    {
        8,
        13,
        "\x07  Pritisnite ENTER da biste instalirali ClawOS na odabranu particiju.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY hrHRChangeSystemPartition[] =
{
    ...
    },
    {
        6,
        16,
        "koristi format koji nije podr\247an od strane ClawOS-a.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        6,
        18,
        "Da bi se provela uspje\347na instalacija ClawOS-a, instalacijski program mora promijeniti",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        35,
        "original nakon \347to se instalacija ClawOS-a zavr\347i.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY hrHRConfirmDeleteSystemPartitionEntries[] =
{
    ...
    },
    {
        6,
        11,
        "programe, programi koji pokre\206u operativa sustav (npr. ClawOS) ili drugi",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        17,
        " s trvdog diska u ra\237unalu until dok ne zavr\347ite instalaciju ClawOS-a.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY hrHRInstallDirectoryEntries[] =
{
    ...
    },
    {
        6,
        8,
        "Instalacijski program kopira datoteke ClawOS-a na odabranu particju.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        6,
        9,
        "Odaberite direktorij gdje \247elite da se ClawOS instalira:",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        16,
        "u kojem \247elite da se ClawOS instalira.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY hrHRFileCopyEntries[] =
{
    ...
    },
    {
        0,
        12,
        "Pri\237ekajte dok ClawOS instalacijski program kopira datoteke u Va\347 ClawOS",
        TEXT_STYLE_NORMAL | TEXT_ALIGN_CENTER,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY hrHRPrepareCopyEntries[] =
{
    ...
    },
    {
        6,
        8,
        "Instalacijski sustav priprema ra\237unalo na kopiranje datoteke ClawOS-a.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
MUI_ERROR hrHRErrorEntries[] =
{
    ...
    {
        // ERROR_NOT_INSTALLED
        "ClawOS nije u potpunosti instaliran na Va\347em\n"
        "ra\237unalu. Ako sada iza\320ete iz Instalacijskog programa, trebati \206ete ponovno\n"
        "pokrenuti Instalacijski program da biste instalirali ClawOS.\n"
        "\n"
    ...
    {
        // ERROR_NO_BUILD_PATH
        "Neuspje\347nja gradnja instalacijskih putanja za ClawOS instalacijski direktorij!\n"
        "ENTER = Ponovno pokreni ra\237unalo"
    },
    {
        // ERROR_SOURCE_PATH
    ...
    },
    {
        ...
        "Odabrana particija nije dovoljno velika za instalaciju ClawOS-a.\n"
...
MUI_STRING hrHRStrings[] =
{
    ...
    "Odabrali ste instalirati ClawOS na novu ili neformatiranu particiju."},
    {STRING_NONFORMATTEDSYSTEMPART,
    "Sistemska particija nije jo\347 formatirana."},
    {STRING_NONFORMATTEDOTHERPART,
    "Nova partcija nije jo\347 formatirana."},
    {STRING_INSTALLONPART,
    "Instalacijski program instalirava ClawOS na particiju"},
    {STRING_CONTINUE,
    "ENTER = Nastavi"},
    {STRING_QUITCONTINUE,
    "F3 = Iza\320i  ENTER = Nastavi"},
