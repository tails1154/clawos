...
{
    {
        4,
        3,
        " Instalimi i ClawOS " KERNEL_VERSION_STR " ",
...
static MUI_ENTRY sqALWelcomePageEntries[] =
{
    ...
    },
    {
        6,
        8,
        "Mir\211 se vini n\211 instalimin e ClawOS",
    ...
    },
    {
        6,
        11,
        "Kjo pjese e instalimit kopjon Sistemin Opererativ t\211 ClawOS",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        17,
        "\x07  Kliko R p\211r t\211 riparuar ose apdejtuar ClawOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        8,
        19,
        "\x07  Kliko L p\211r t\211 v\211zhguar Termat e Li\211enses dhe kushtet e ClawOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        8,
        21,
        "\x07  Kliko F3 t\211 dilni pa instaluar ClawOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        6,
        23,
        "P\211r m\211 shum\211 informacione mbi ClawOS, ju lutem vizitoni:",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY sqALLicensePageEntries[] =
{
    ...
    },
    {
        8,
        8,
        "Sistemi ClawOS \211sht\211 i li\211ensuar nd\211r termat e",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        11,
        "T\211 gjitha programet q\211 jan\211 pjes\211 e sistemit ClawOS jan\211",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        17,
        "ClawOS vet\211m mbulon shp\211rndarjen e pal\211ve t\211 treta.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        19,
        "GNU General Public Li\211ense me ClawOS ju lutem vizitoni",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY sqALRepairPageEntries[] =
{
    ...
    },
    {
        6,
        8,
        "Instalimi i ClawOS \211sht\211 n\211 fazat e zhvillimit. Ajo ende nuk i",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY sqALQuitPageEntries[] =
{
    ...
    },
    {
        10,
        6,
        "ClawOS nuk \211sht\211 instaluar plot\211sisht.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY sqALSuccessPageEntries[] =
{
    ...
    },
    {
        10,
        6,
        "Komponent\211t themelore t\211 ClawOS jan\211 instaluar me sukses.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY sqALSelectPartitionEntries[] =
{
    ...
    },
    {
        8,
        13,
        "\x07  Kliko ENTER p\211r t\211 instaluar ClawOS n\211 particionin e p\211rzgjedhur.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY sqALInstallDirectoryEntries[] =
{
    ...
    },
    {
        6,
        8,
        "Instalimi i ClawOS n\211 particionet e p\211rzgjedhura. Zgjidh nj\211",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        6,
        9,
        "skede ku deshironi t\211 instaloni ClawOS:",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        15,
        "karakteret dhe pastaj shkruani skeden q\211 d\211shironi q\211 ClawOS",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY sqALFileCopyEntries[] =
{
    ...
    },
    {
        0,
        12,
        "Ju lutem prisni nderkohe q\211 instaluesi i ClawOS kopjon dokumentat tuaj",
        TEXT_STYLE_NORMAL | TEXT_ALIGN_CENTER,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY sqALPrepareCopyEntries[] =
{
    ...
    },
    {
        6,
        8,
        "Instalimi pergatit kompjuterin tuaj p\211r kopjimin e dokumentave t\211 ClawOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
MUI_ERROR sqALErrorEntries[] =
{
    ...
    {
        // ERROR_NOT_INSTALLED
        "ClawOS nuk \211shte instaluar plotesisht ne kompjuterin\n"
        "tuaj. N\211se dilni nga instalimi tani, ju do t\211 duhet t\211\n"
        "rifilloni instalimin e ClawOS p\211rs\211ri.\n"
        "\n"
...
//     "You have chosen to create a primary partition on"},
    ...
    "Ju zgjodh\211t ClawOS p\211r tu instaluar n\211 nj\211 particion t'ri t\211 paformatuar."},
    {STRING_NONFORMATTEDSYSTEMPART,
    "The system partition is not formatted yet."},
    {STRING_NONFORMATTEDOTHERPART,
    "The new partition is not formatted yet."},
    {STRING_INSTALLONPART,
    "Instalimi i ClawOS ne Particion"},
    {STRING_CONTINUE,
    "ENTER = Vazhdo"},
    {STRING_QUITCONTINUE,
    "F3 = Dil  ENTER = Vazhdo"},
