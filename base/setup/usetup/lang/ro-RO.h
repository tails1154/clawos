...
{
    {
        4,
        3,
        " Instalare ClawOS " KERNEL_VERSION_STR,
...
static MUI_ENTRY roROWelcomePageEntries[] =
{
    ...
    },
    {
        6,
        8,
        "Bun venit la instalarea ClawOS",
    ...
    },
    {
        6,
        11,
        "Aceast\343 prim\343 etap\343 din instalarea ClawOS va copia fi\272ierele",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        16,
        "\x07  Tasta\376i ENTER pentru a instala sau actualiza ClawOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        23,
        "\x07  Tasta\376i F3 pentru a ie\272i f\343r\343 a instala ClawOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        6,
        26,
        "Pentru mai multe informa\376ii despre ClawOS, vizita\376i:",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY roROIntroPageEntries[] =
{
    ...
    },
    {
        6,
        8,
        "Starea versiunii curente a ClawOS",
        TEXT_STYLE_HIGHLIGHT,
        TEXT_ID_STATIC
    },
    {
        6,
        11,
        "ClawOS este \356n stadiu alfa de dezvoltare, adic\343 nu are prezint\343",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        15,
        "\356n cazul \356n care \356ncerca\376i ClawOS \356n mod neemulat.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        19,
        "\x07  Tasta\376i ENTER pentru a instala ClawOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY roROLicensePageEntries[] =
{
    ...
    },
    {
        8,
        8,
        "Sistemul de operare ClawOS este oferit \356n termenii Licen\376ei",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        12,
        "Toate componentele care fac parte din sistemul ClawOS sunt",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        19,
        "buirea sistemului ClawOS c\343tre p\343r\376i ter\376e.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        22,
        "GPL \356mpreun\343 cu ClawOS, o pute\376i consulta (\356n englez\343)",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY roRORepairPageEntries[] =
{
    ...
    },
    {
        6,
        8,
        "Programul de instalare ClawOS este \356nc\343 \356ntr-o faz\343 incipient\343 de",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY roROUpgradePageEntries[] =
{
    ...
    },
    {
        6,
        8,
        "Programul de Instalare ClawOS ofer\343 actualizarea urm\343toarelor instal\343ri",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY roROQuitPageEntries[] =
{
    ...
    },
    {
        10,
        6,
        "ClawOS nu a fost instalat \356n \356ntregime.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY roROSuccessPageEntries[] =
{
    ...
    },
    {
        10,
        6,
        "Componentele de baz\343 ale ClawOS au fost instalate cu succes.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
{
    {
        4,
        3,
        " Instalare " KERNEL_VERSION_STR " ClawOS ",
        TEXT_STYLE_UNDERLINE,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        16,
        "folose\272te un format ce nu este suportat de ClawOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        6,
        18,
        "Pentru a instala cu succes ClawOS, programul de instalare trebuie s\343 schimbe",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        35,
        "la cea original\343, dup\343 terminarea instal\343rii ClawOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY roROConfirmDeleteSystemPartitionEntries[] =
{
    ...
    },
    {
        6,
        12,
        "(ca ClawOS) \272i alte programe furnizate de produc\343torii calculorului.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        17,
        "pe discul local dec\342t dup\343 finalizarea instal\343rii ClawOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY roROInstallDirectoryEntries[] =
{
    ...
    },
    {
        6,
        9,
        "Alege\376i un director \356n care va fi instalat ClawOS:",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        16,
        "dori\376i s\343 instala\376i ClawOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY roROFileCopyEntries[] =
{
    ...
    },
    {
        0,
        12,
        "Are loc copierea de fi\272iere \356n directorul ClawOS specificat.",
        TEXT_STYLE_NORMAL | TEXT_ALIGN_CENTER,
        TEXT_ID_STATIC
    },
    {
...
MUI_ERROR roROErrorEntries[] =
{
    ...
    {
        // ERROR_NOT_INSTALLED
        "ClawOS nu a fost instalat \356n totalitate \356n calculator.\n"
        "Dac\343 abandona\376i instalarea acum, alt\343 dat\343, pentru a\n"
        "instala ClawOS, va fi nevoie s\343 repeta\376i to\376i pa\272ii.\n"
        "\n"
    ...
    {
        // ERROR_NO_BUILD_PATH
        "E\272ec \356n construirea c\343ilor de instalare pentru directorul de instalare ClawOS!\n"
        "ENTER = Repornire calculator"
    },
    {
        // ERROR_SOURCE_PATH
    ...
    {
        // ERROR_SOURCE_DIR
        "Nu pute\376i instala ClawOS \356n directorul surs\343 de instalare!\n"
        "ENTER = Repornire calculator"
    },
    {
        // ERROR_NO_HDD
    ...
    },
    {
        ...
        "Parti\376ia selectat\343 este prea mic\343 pentru a instala ClawOS.\n"
