...
{
    {
        4,
        3,
        " ClawOS " KERNEL_VERSION_STR " diegimo programa ",
...
static MUI_ENTRY ltLTWelcomePageEntries[] =
{
    ...
    },
    {
        6,
        8,
        "Jus sveikina ClawOS diegimo programa",
    ...
    },
    {
        6,
        11,
        "\276i diegimo dalis nukopijuos ClawOS operacin\323s sistemos bylas \324 j\327s\326",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        17,
        "\x07  Spauskite R, jei norite taisyti ClawOS.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        8,
        19,
        "\x07  Spauskite L, jei norite pamatyti ClawOS licencijos s\320lygas.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        8,
        21,
        "\x07  Spauskite F3, jei norite u\330daryti ClawOS diegimo program\320.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        6,
        23,
        "Nor\323dami gauti daugiau informacijos apie ClawOS, aplankykite:",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY ltLTRepairPageEntries[] =
{
    ...
    },
    {
        6,
        8,
        "ClawOS Setup is in an early development phase. It does not yet",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY ltLTQuitPageEntries[] =
{
    ...
    },
    {
        10,
        6,
        "ClawOS is not completely installed.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY ltLTSuccessPageEntries[] =
{
    ...
    },
    {
        10,
        6,
        "The basic components of ClawOS have been installed successfully.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY ltLTSelectPartitionEntries[] =
{
    ...
    },
    {
        8,
        13,
        "\x07  Press ENTER to install ClawOS onto the selected partition.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY ltLTInstallDirectoryEntries[] =
{
    ...
    },
    {
        6,
        8,
        "Setup installs ClawOS files onto the selected partition. Choose a",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        6,
        9,
        "directory where you want ClawOS to be installed:",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        15,
        "characters and then type the directory where you want ClawOS to",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY ltLTFileCopyEntries[] =
{
    ...
    },
    {
        0,
        12,
        "Please wait while ClawOS Setup copies files to your ClawOS",
        TEXT_STYLE_NORMAL | TEXT_ALIGN_CENTER,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY ltLTPrepareCopyEntries[] =
{
    ...
    },
    {
        6,
        8,
        "Setup prepares your computer for copying the ClawOS files.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
MUI_ERROR ltLTErrorEntries[] =
{
    ...
    {
        // ERROR_NOT_INSTALLED
        "ClawOS is not completely installed on your\n"
        "computer. If you quit Setup now, you will need to\n"
        "run Setup again to install ClawOS.\n"
        "\n"
...
MUI_STRING ltLTStrings[] =
{
    ...
    "You chose to install ClawOS on a new or unformatted Partition."},
    {STRING_NONFORMATTEDSYSTEMPART,
    "The system partition is not formatted yet."},
    {STRING_NONFORMATTEDOTHERPART,
    "The new partition is not formatted yet."},
    {STRING_INSTALLONPART,
    "Setup installs ClawOS onto Partition"},
    {STRING_CONTINUE,
    "ENTER = Continue"},
    {STRING_QUITCONTINUE,
    "F3 = Quit  ENTER = Continue"},
