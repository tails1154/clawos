...
static MUI_ENTRY trTRSetupInitPageEntries[] =
{
    ...
    },
    {
        0,
        20,
        "ClawOS Kurulumu kendini ba\237lat\215rken ve ayg\215tlar\215n\215z\215",
...
static MUI_ENTRY trTRWelcomePageEntries[] =
{
    ...
    },
    {
        6,
        8,
        "ClawOS Kurulum Sihirbaz\215na ho\237 geldiniz.",
    ...
    },
    {
        6,
        11,
        "Kurulumun bu b\224l\201m\201, ClawOS \230\237letim Sistemi'ni bilgisayar\215n\215za",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        15,
        "\x07  ClawOS'u y\201klemek ya da y\201kseltmek i\207in ENTER'e bas\215n\215z.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        8,
        17,
        "\x07  ClawOS'u onarmak veya y\201kseltmek i\207in R'ye bas\215n\215z.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        8,
        19,
        "\x07  ClawOS Lisans Terimleri'ni ve \236artlar\215'n\215 g\224rmek i\207in L'ye bas\215n\215z.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        8,
        21,
        "\x07  ClawOS'u kurmadan \207\215kmak i\207in F3'e bas\215n\215z.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY trTRIntroPageEntries[] =
{
    ...
    },
    {
        6,
        11,
        "ClawOS alfa a\237amas\215ndad\215r, \224zellikleri tamamlanmam\215\237 anlam\215na gelmektedir",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        15,
        "E\247er, ClawOS'u ger\207ek donan\215m \201zerinde \207al\215\237t\215rmay\215 deneyecekseniz",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        19,
        "\x07  ClawOS Kur'a devam etmek i\207in ENTER'e bas\215n\215z.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY trTRLicensePageEntries[] =
{
    ...
    },
    {
        8,
        8,
        "ClawOS Sistemi, GNU GPL'yle X11, BSD ve GNU LGPL",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        11,
        "Bu y\201zden ClawOS sisteminin b\224l\201m\201 olan t\201m yaz\215l\215mlar, korunan",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        15,
        "\201zerine hi\207bir g\201vence ve k\215s\215tlamayla gelmez. ClawOS'un",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        17,
        "E\247er baz\215 nedenlerden dolay\215 ClawOS ile GNU Genel",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY trTRRepairPageEntries[] =
{
    ...
    },
    {
        6,
        8,
        "ClawOS Kur, bir \224n geli\237me evresindedir. Daha t\201m\201yle kullan\215\237l\215",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY trTRUpgradePageEntries[] =
{
    ...
    },
    {
        6,
        8,
        "ClawOS Kur, a\237a\247\215da listelenen bir mevcut ClawOS kurulumunu",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
        6,
        9,
        "y\201kseltebilir ya da ClawOS kurulumu zarar g\224rm\201\237se Kur, onu",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        8,
        21,
        "\x07  ClawOS kurmadan \207\215kmak i\207in F3'e bas\215n\215z.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY trTRQuitPageEntries[] =
{
    ...
    },
    {
        10,
        6,
        "ClawOS, t\201m\201yle kurulmad\215.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY trTRSuccessPageEntries[] =
{
    ...
    },
    {
        10,
        6,
        "ClawOS'un ana bile\237enleri ba\237ar\215yla kuruldu.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY trTRSelectPartitionEntries[] =
{
    ...
    },
    {
        8,
        13,
        "\x07  Se\207ili b\224l\201me ClawOS'u y\201klemek i\207in ENTER'e bas\215n\215z.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY trTRChangeSystemPartition[] =
{
    ...
    },
    {
        6,
        12,
        "b\224l\201m\201, ClawOS taraf\215ndan desteklenmeyen",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        18,
        "ClawOS'u ba\237ar\215yla kurmak i\207in, Kurulum program\215 mevcut",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        34,
        "gerekebilir veya ClawOS kurulumunu tamamlad\215ktan sonra sistem ",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY trTRConfirmDeleteSystemPartitionEntries[] =
{
    ...
    },
    {
        6,
        11,
        "programlar\215, ClawOS gibi bir i\237letim sistemini ba\237latmak i\207in programlar",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        16,
        "B\224l\201m\201 sildi\247inizde ClawOS Kur'u bitirene kadar bilgisayar\215 sabit diskten",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY trTRInstallDirectoryEntries[] =
{
    ...
    },
    {
        6,
        8,
        "Kur, se\207ili b\224l\201me ClawOS dosyalar\215n\215 y\201kler. ClawOS'un",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
    ...
    },
    {
        6,
        15,
        "bas\215n\215z ve ard\215ndan ClawOS'un y\201klenmesini istedi\247iniz dizini yaz\215n\215z.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY trTRFileCopyEntries[] =
{
    ...
    },
    {
        0,
        12,
        "ClawOS Kur, ClawOS kurulum dizininize dosyalar\215 kopyalarken",
        TEXT_STYLE_NORMAL | TEXT_ALIGN_CENTER,
        TEXT_ID_STATIC
    },
    {
...
static MUI_ENTRY trTRPrepareCopyEntries[] =
{
    ...
    },
    {
        6,
        8,
        "Kur, ClawOS dosyalar\215n\215 kopyalamak i\207in bilgisayar\215n\215z\215 haz\215rl\215yor.",
        TEXT_STYLE_NORMAL,
        TEXT_ID_STATIC
    },
    {
...
MUI_ERROR trTRErrorEntries[] =
{
    ...
    {
        // ERROR_NOT_INSTALLED
        "ClawOS, bilgisayara t\201m\201yle kurulmad\215. E\247er \237imdi\n"
        "Kur'dan \207\215karsan\215z ClawOS'u kurmak i\207in Kur'u\n"
    ...
    {
        // ERROR_NO_BUILD_PATH
        "ClawOS kurulum dizini i\207in kurulum yollar\215 olu\237turulamad\215!!\n"
        "ENTER = Bilgisayar\215 Yeniden Ba\237lat"
    },
    {
        // ERROR_SOURCE_PATH
    ...
    {
        // ERROR_SOURCE_DIR
        "ClawOS'u kurulum kaynak dizini i\207ine kuramazs\215n\215z!\n"
        "ENTER = Bilgisayar\215 Yeniden Ba\237lat"
    },
    {
        // ERROR_NO_HDD
    ...
    },
    {
        ...
        "Se\207ili b\224l\201m ClawOS'u kurmak i\207in yeteri katar b\201y\201k de\247il.\n"
...
MUI_STRING trTRStrings[] =
{
    ...
    "ClawOS'u yeni ya da bi\207imlendirilmemi\237 bir b\224l\201me kurmay\215 se\207tiniz."},
    {STRING_NONFORMATTEDSYSTEMPART,
    "Sistem b\224l\201m\201 hen\201z bi\207imlendirilmemi\237."},
    {STRING_NONFORMATTEDOTHERPART,
    "Yeni b\224l\201m hen\201z bi\207imlendirilmemi\237."},
    {STRING_INSTALLONPART,
    "Kur, ClawOS'u b\224l\201m \201zerine kurar."},
    {STRING_CONTINUE,
    "ENTER = Devam Et"},
    {STRING_QUITCONTINUE,
    "F3 = \200\215k   ENTER = Devam Et"},
