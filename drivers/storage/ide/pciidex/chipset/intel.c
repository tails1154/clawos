...
/*
 * PXB configuration register (450NX)
 */
...
/*
 * IDE timing register (PIIX, MPIIX, PIIX3/4, ICH)
 *
...
/*
 * Slave IDE timing register (PIIX3/4, ICH)
 */
...
/*
 * Ultra DMA control register (PIIX4, ICH)
 */
...
/*
 * Ultra DMA timing register (PIIX4, ICH)
 *
...
/*
 * Device 0/1 Timing Register (SCH)
 */
    ...
    _In_reads_(MAX_IDE_DEVICE) PCHANNEL_DEVICE_CONFIG* DeviceList)
{
    ...
    /* Force reload of timings */
    HwExt->CurrentTiming = 0;
}

/*
 * Intel 450KX/GX PCIset Specification Update 243109-015
 * Intel 450NX PCIset Specification Update 243848-009
 */
static
CODE_SEG("PAGE")
BOOLEAN
    ...
    _Inout_ PATA_CONTROLLER Controller)
{
    ...
    switch (ControllerInfo->Type)
    {
        case TYPE_MPIIX:
            /*
             * This is a bridge device and there are no PCI BAR resources allocated,
