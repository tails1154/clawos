...
/* The Partition Manager Driver in ClawOS complements disk.sys/classpnp.sys drivers
 ...
 * exist in ClawOS. Thus handles some IOCTL_VOLUME_*, and IOCTL_MOUNTMGR_* IOCTLs.
 */
