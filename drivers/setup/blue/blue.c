/*
 * PROJECT:     ClawOS Console Text-Mode Device Driver
...
/*
 * (Adapted for ClawOS/Win2k3 from an original comment
 ...
 *
 * In ClawOS things are a little bit different. We want to have a functional
