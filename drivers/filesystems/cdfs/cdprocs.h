...
static /* ClawOS Change: GCC "multiple definition" */
...
#define CdFreeIoContext(IO)     CdFreePool( (PVOID) &(IO) ) /* ClawOS Change: GCC "passing argument 1 from incompatible pointer type" */
...
//
/* ClawOS Change: GCC "passing argument 1 of CdFreePool from incompatible pointer type" */
