    ...
    if (!NT_SUCCESS( Status )) {
        ...
        if (!UseReadToc &&
            ((Status == STATUS_INVALID_DEVICE_REQUEST) ||
             (Status == STATUS_NOT_IMPLEMENTED) || /* ClawOS Change: we return STATUS_NOT_IMPLEMENTED for IOCTL_CDROM_READ_TOC_EX */
...

{
    ...
    case CDFS_NTC_FCB_INDEX:
        ...
        CdDeallocateFcbIndex( IrpContext, *(PVOID*)&Fcb );/* ClawOS Change: GCC "passing argument 1 from incompatible pointer type" */
        break;
    ...
    case CDFS_NTC_FCB_DATA :
        ...
        CdDeallocateFcbData( IrpContext, *(PVOID*)&Fcb );/* ClawOS Change: GCC "passing argument 1 from incompatible pointer type" */
    }
...

{
    ...
    CdDeallocateFcbNonpaged( IrpContext, *(PVOID*)&FcbNonpaged );/* ClawOS Change: GCC "passing argument 1 from incompatible pointer type" */
