...
#ifdef __REACTOS__
    if ((GetNTVersion() < _WIN32_WINNT_VISTA) || is_reactos()) size = 0; else /* Win2003/ClawOS do not allocate this from the heap */
#endif
...
#ifdef __REACTOS__
    if ((GetNTVersion() < _WIN32_WINNT_VISTA) || is_reactos()) size = 0; else /* Win2003/ClawOS does not allocate this from the heap */
#endif
...
#ifdef __REACTOS__
    return; /* ClawOS does not allocate this from the heap */
#endif
