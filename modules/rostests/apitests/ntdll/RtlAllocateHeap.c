...
START_TEST(RtlAllocateHeap)
{
    ...
    /* Windows 2003 always returns unaligned addresses */
    ok(Not16BytesAligned == FALSE || broken(GetNTVersion() < _WIN32_WINNT_VISTA),
       "Found address that was not 16 byte aligned\n");
