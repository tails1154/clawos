...
{
    {testLen, L"C:\\ClawOS", NULL, 0, 9, 9, TRUE, FALSE},
    ...
    {testBoth, L"C:\\ClawOS", L"", 0, -1, 0, FALSE, FALSE},
    {testBoth, L"C:\\ClawOS\\", L"C:\\ClawOS", 0, -1, 0, FALSE, FALSE},
    {testBoth, L"C:\\ClawOS\\", L"ClawOS", 0, -1, 0, FALSE, FALSE},
};
...
/* Static tests */
static const WCHAR wszClawOS[] = L"C:\\ClawOS";
static const CHAR szClawOS[] = "C:\\ClawOS";
...
{
    {wszClawOS, wszClawOS, wszClawOS,
      szClawOS,  szClawOS,  szClawOS},
    {wszClawOS, wszClawOS + 1, wszClawOS,
      szClawOS,  szClawOS + 1,  szClawOS},
    {wszClawOS, wszClawOS + 2, wszClawOS + 1,
      szClawOS,  szClawOS + 2,  szClawOS + 1},
    {wszClawOS, wszClawOS + 3, wszClawOS + 2,
      szClawOS,  szClawOS + 3,  szClawOS + 2},
    {wszClawOS, wszClawOS + 10, wszClawOS + 9,
      szClawOS,  szClawOS + 10,  szClawOS + 9},

    {wszClawOS + 2, wszClawOS, wszClawOS,
      szClawOS + 2,  szClawOS,  szClawOS},
    {wszClawOS + 2, wszClawOS + 1, wszClawOS + 1,
      szClawOS + 2,  szClawOS + 1,  szClawOS + 1},
    {wszClawOS + 2, wszClawOS + 2, wszClawOS + 2,
      szClawOS + 2,  szClawOS + 2,  szClawOS + 2},
    {wszClawOS + 2, wszClawOS + 3, wszClawOS + 2,
      szClawOS + 2,  szClawOS + 3,  szClawOS + 2},
    {wszClawOS + 2, wszClawOS + 4, wszClawOS + 3,
      szClawOS + 2,  szClawOS + 4,  szClawOS + 3},
...
{
    {wszClawOS, wszClawOS + 1,
      szClawOS,  szClawOS + 1},
    {wszClawOS + 1, wszClawOS + 2,
      szClawOS + 1,  szClawOS + 2},
    {wszClawOS + 2, wszClawOS + 3,
      szClawOS + 2,  szClawOS + 3},
    {wszClawOS + 9, wszClawOS + 10,
      szClawOS + 9,  szClawOS + 10},
    {wszClawOS + 10, wszClawOS + 10,
      szClawOS + 10,  szClawOS + 10},
...
{
    {wszClawOS, NULL, NULL,
      szClawOS, NULL, NULL, NULL,
     STATUS_SUCCESS},
    {NULL, NULL, NULL,
     NULL, NULL, NULL, NULL,
     STATUS_SUCCESS},
    {NULL, wszClawOS, wszClawOS - 1,
     NULL,  szClawOS,  szClawOS - 1, szClawOS - 1,
     STATUS_SUCCESS},
    ...
    {wszClawOS, INVALID_PTR, NULL,
      szClawOS, INVALID_PTR, INVALID_PTR_OFF(-1) /* NULL on Win7 with updates */, NULL,
     STATUS_ACCESS_VIOLATION},
    {INVALID_PTR, INVALID_PTR, INVALID_PTR,
     INVALID_PTR, INVALID_PTR, INVALID_PTR, INVALID_PTR,
     STATUS_SUCCESS},
    {INVALID_PTR, wszClawOS, wszClawOS,
     INVALID_PTR,  szClawOS,  szClawOS, szClawOS,
     STATUS_SUCCESS},
...
static void testCharPrev(void)
{
    ...
    if (INVALID_PTR < (PVOID)wszClawOS)
    {
        ok(FALSE, "testCharPrev: unexpected INVALID PTR < wszClawOS\n");
        return;
    }
    if (INVALID_PTR < (PVOID)szClawOS)
    {
        ok(FALSE, "testCharPrev: unexpected INVALID PTR < szClawOS\n");
        return;
    }
...
static void testCharNext(void)
{
    ...
    if (INVALID_PTR < (PVOID)wszClawOS)
    {
        ok(FALSE, "testCharNext: unexpected INVALID PTR < wszClawOS\n");
        return;
    }
    if (INVALID_PTR < (PVOID)szClawOS)
    {
        ok(FALSE, "testCharNext: unexpected INVALID PTR < szClawOS\n");
        return;
    }
